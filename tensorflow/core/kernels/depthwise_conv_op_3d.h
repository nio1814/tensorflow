...
#ifndef THIRD_PARTY_TENSORFLOW_CORE_KERNELS_DEPTHWISE_CONV3D_OP_H_
#define THIRD_PARTY_TENSORFLOW_CORE_KERNELS_DEPTHWISE_CONV3D_OP_H_
...
struct LaunchDepthwiseConv3dOp {
...
struct DepthwiseFilterPadOp {
  void operator()(const Depthwise3DArgs& args, const T* filter,
                  T* padded_filter) {
...
#endif  // TENSORFLOW_CORE_KERNELS_DEPTHWISE_CONV3D_OP_H_
